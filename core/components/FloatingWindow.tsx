...
import { useWindowBounds } from "@core/hooks";
		...
		>
			{children ? (
				<div className="h-full w-full flex flex-col overflow-y-auto">
					<Core.Header className="rounded-none border-4 border-zinc-900 px-1.5 py-0 text-xl sticky top-0 touch-none z-[2]" {...bind()}>
